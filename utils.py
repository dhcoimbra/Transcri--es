...
### Essa é a função original que funciona
def criar_documento_para_lote_FUNCIONANDO(df_lote, audio_dir, lote_num, progress_bar, linhas_processadas, total_linhas):
    doc = Document()
    table = doc.add_table(rows=1, cols=4)
    table.autofit = False
