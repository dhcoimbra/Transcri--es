...
def selecionar_pasta():
    # Cria um script Python temporário para abrir o diálogo de seleção de pasta
    script = """
...
if folder_selected:
    ...
    print("")
"""
    # Executa o script em um subprocesso para evitar conflitos de thread
    result = subprocess.run([sys.executable, "-c", script], capture_output=True, text=True)
    folder_path = result.stdout.strip()  # Captura a saída do script
    return folder_path

def localizar_arquivo_excel(pasta_usuario):
    """
